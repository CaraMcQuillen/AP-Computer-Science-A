...
public class TwoDArrayMethods
{
    ...
    */
    ...
    public static void findMax(int[][] matrix)
    {
       ...
       System.out.print("The maximum value in the entire matrix is " + max);
    }
    ...
    public static void sumRows(int[][] matrix)
    {
        for(int i = 0; i < matrix.length; i++)
       {
           ...
           System.out.print("The sum of the elements in row " + i + "is " + rowSum);
        }
    }
    ...
    public static void sumColumns(int[][] matrix)
   {
        for(int j = 0; j < matrix[0].length; j++)
       {
           ...
           System.out.print("The sum of the elements in column " + j + "is " + columnSum);
        }
    }
    ...
    public static void largestinRows(int[][] matrix)
    {
          for(int i = 0; i < matrix.length; i++)
       {
           ...
           System.out.print("The largest value in row " + i + "is " + rowMax);
        } 
    }
    ...
    public static void largestinColumns(int[][] matrix)
    {
         for(int j = 0; j < matrix[0].length; j++)
       {
           ...
           System.out.print("The largest value in column " + j + "is " + columnMax);
        }
    }
